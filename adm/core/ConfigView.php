...
class ConfigView
{
    ...
    public function rederizarLogin (){
        if(file_exists('app/'.$this->nome . '.php')){
            /* verificação e inclusao do arquivo pagina da views selecionadas*/

            include 'app/'.$this->nome .'.php';
            //include 'app/adms/Views/include/head_login/head_login.php';
           // include 'app/adms/Views/login/login.php';
            //include 'app/adms/Views/include/head_login/footer.php';
